...
//Ме́тод в объектно-ориентированном программировании —
// это функция или процедура, принадлежащая какому-то классу или объекту.
// Как и процедура в процедурном программировании, метод состоит из некоторого
// количества операторов
// для выполнения какого-то действия и имеет набор входных аргументов.

//Private — наиболее строгий модификатор доступа.
...
// виден  для классов определенных в том же пакете или для классов наследников

//Void ничего не возвращает;
// он сообщает компилятору, что метод не имеет возвращаемого значения.
